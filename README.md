# HARVESTIFY 🌿  <small>An Environmental Intelligence System</small>
...
- Clone the complete project with `https://github.com/bhoomikamittal8/harvestify_university_project.git` or you can just download the code and unzip it
- **Note:** The master branch doesn't have the updated code used for deployment, to download the updated code used for deployment you can use the following command
  ```
  ❯ git clone -b deploy https://github.com/bhoomikamittal8/harvestify_university_project.git
  ```
...
- Once the project is cloned, open anaconda prompt in the directory where the project was cloned and paste the following block
  ...
  ```
- Note That: Virtual Environment is only created once Say '_harvestify_',
...
#### If you have any doubt or want to contribute feel free to email me or hit me up on [LinkedIn](https://www.linkedin.com/in/bhoomikamittal48/)
